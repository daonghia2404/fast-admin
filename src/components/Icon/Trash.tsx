...
const Svg: React.FC<TSvgProps> = ({ color = EIconColor.BLACK }) => {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M6.75 6.75H7.875V13.5H6.75V6.75Z" fill={color} />
      <path d="M10.125 6.75H11.25V13.5H10.125V6.75Z" fill={color} />
      <path
        ...
        fill={color}
      />
      <path d="M6.75 1.125H11.25V2.25H6.75V1.125Z" fill={color} />
    </svg>
  );
};
