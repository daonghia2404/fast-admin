...
const ModalConfirm: React.FC<TModalConfirmProps> = ({ visible, title, description, onSubmit, onClose }) => {
  return (
    <Modal visible={visible} onClose={onClose} wrapClassName="ModalConfirm-wrapper" maxWidth="60rem">
      ...
      <div className="ModalConfirm-actions flex justify-between">
        <Button type="primary" title="Đồng ý" onClick={onSubmit} />
        <Button className="outline-primary" title="Huỷ bỏ" onClick={onClose} />
      </div>
    </Modal>
  );
};
